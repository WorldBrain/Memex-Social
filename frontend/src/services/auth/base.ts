...
import { AuthService, AuthLoginFlow, AuthRequest, AuthMethod, AuthEvents, AuthResult, EmailPasswordCredentials, RegistrationResult, LoginResult } from "./types";
...
export abstract class AuthServiceBase implements AuthService {
    ...
    abstract loginWithEmailPassword(options: EmailPasswordCredentials): Promise<{ result: LoginResult }>
    abstract registerWithEmailPassword(options: EmailPasswordCredentials): Promise<{ result: RegistrationResult }>
