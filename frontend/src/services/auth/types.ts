...
export interface AuthService {
    ...
    loginWithEmailPassword(options: EmailPasswordCredentials): Promise<{ result: LoginResult }>
    registerWithEmailPassword(options: EmailPasswordCredentials): Promise<{ result: RegistrationResult }>
...
export interface LoginError {
    status: 'error';
    reason: 'popup-blocked' | 'invalid-email' | 'user-not-found' | 'wrong-password' | 'unknown';
